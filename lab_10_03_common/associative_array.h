...
/**
 * Сравнивает значения в ассоц. массиве со значениями из переданного массива
 *
 * \param[in] arr - описатель массива
 * \param[in] values - массив значений
 * \param[in] cnt - количество элементов массива значений
 *
 * \return ASSOC_ARRAY_OK или код ошибки (ASSOC_ARRAY_INVALID_PARAM, ASSOC_ARRAY_NOT_FOUND - т.е. нашлись несовпадающие элементы)
 */
